...
install_onlyoffice() {
	wget https://github.com/ONLYOFFICE/DesktopEditors/releases/latest/download/onlyoffice-desktopeditors_amd64.deb -O /tmp/onlyoffice.deb
...
check_if_program_installed "pyright" || pipx install pyright
...
check_if_program_installed "nvim" || install_neovim
...
if [ ! -d "/home/invertedecho/.zsh/pure" ]
then
	echo "Downloading up pure-prompt..."
	git clone https://github.com/sindresorhus/pure.git "$HOME/.zsh/pure"
else
	echo "pure-prompt already downloaded, skipping"
fi
